...
function print_status(status) {
	if (status == 'trusted') return '&nbsp;<img src="' + static_server + '/images/trusted.gif" alt="Trusted" />';
...
function make_details() {
	let json_obj = JSON.parse(Get(server + '/api/torrent?id='+encodeURIComponent(getParameterByName('id'))));
	...
	if ( elements.hasOwnProperty('imdb') ) {
		if ( elements['imdb'] !== null ) {
			document.getElementById("imdb").innerHTML='<div><dt class="dt-sm">IMDB:</dt><dd><a href="https://www.imdb.com/title/' + elements['imdb'] + '" target="_imdb">' + elements['imdb'] + '</a>&nbsp;&nbsp;<a href="/search.html?q=' + elements['imdb'] + '">[search on TPB]</a></dd></div>';
		}
	}
}
...
'<a href="/browse.html" title="Browse Torrents">Browse&nbsp;Torrents</a> |\n',
...
'<a href="/search.html?q=category:104" title="FLAC">FLAC</a>\n',
...
'<a href="/search.html?q=category:210" title="CAM/TS">CAM/TS</a>\n',
'<a href="/search.html?q=category:211" title="UHD/4k - Movies">UHD/4k - Movies</a>\n',
'<a href="/search.html?q=category:212" title="UHD/4k - TV shows">UHD/4k - TV shows</a>\n',
...
'<a href="/search.html?q=category:507" title="UHD/4k - Movies">UHD/4k - Movies</a>\n',
...
'<a href="/search.html?q=top100:210" title="CAM/TS">CAM/TS</a> (<a href="/search.html?q=top100:48h_210">48h</a>)\n',
'<a href="/search.html?q=top100:211" title="UHD/4k - Movies">UHD/4k - Movies</a> (<a href="/search.html?q=top100:48h_211">48h</a>)<br />\n',
'<a href="/search.html?q=top100:212" title="UHD/4k - TV shows">UHD/4k - TV shows</a> (<a href="/search.html?q=top100:48h_212">48h</a>)\n',
...
'<a href="/search.html?q=top100:507" title="UHD/4k - Movies">UHD/4k - Movies</a> (<a href="/search.html?q=top100:48h_507">48h</a>)\n',
